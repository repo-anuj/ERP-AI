...
export default function OnboardingPage() {
  ...
  const handleLogoUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    toast({
      title: "Uploading...",
      description: "Processing your logo upload...",
      duration: 2000
    })
    ...
    reader.onload = (e) => {
      ...
      const img = new Image()
      img.onload = () => {
        // Image loaded successfully, save it
        handleInputChange('logo', base64String)
        toast({
          title: "Logo Uploaded Successfully!",
          description: `Image dimensions: ${img.width}x${img.height}px`,
          duration: 3000
        })
      }
      img.onerror = () => {
  ...
  const handleStampUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    toast({
      title: "Uploading...",
      description: "Processing your company stamp...",
      duration: 2000
    })
    ...
    reader.onload = (e) => {
      ...
      const img = new Image()
      img.onload = () => {
        handleInputChange('companyStamp', base64String)
        toast({
          title: "Stamp Uploaded Successfully!",
          description: `Stamp dimensions: ${img.width}x${img.height}px`,
          duration: 3000
        })
      }
      img.onerror = () => {
    ...
    reader.onerror = () => {
      toast({
        title: "Upload Failed",
        description: "Failed to upload the stamp. Please try again.",
        variant: "destructive"
      })
    }
    reader.readAsDataURL(file)
      ...
      <div className="grid gap-6">
            ...
            {formData.logo ? (
              <div className="relative inline-block">
                <img
                  ...
                  className="w-32 h-32 object-contain border rounded-lg mx-auto bg-white"
                />
                <Button
                  type="button"
                  variant="outline"
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm text-muted-foreground">
            Upload your official company stamp for documents and invoices
          </p>
          <div className="space-y-4">
            {formData.companyStamp ? (
              <div className="relative inline-block">
                <img
                  ...
                  className="w-24 h-24 object-contain border rounded-lg mx-auto bg-white"
                />
                <Button
                  type="button"
                  variant="outline"
                  ...
                  onClick={() => handleInputChange('companyStamp', '')}
                >
                  ×
                </Button>
                <div className="text-center mt-2">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="mt-2 space-y-2 text-sm">
            ...
            <p><span className="font-medium">Hours:</span> {typeof formData.operatingHours === 'object' ? JSON.stringify(formData.operatingHours) : formData.operatingHours}</p>
